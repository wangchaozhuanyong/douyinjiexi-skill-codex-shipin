        ...
        json.dumps(
            {
                ...
                "background_template": {
                    "id": "BG_FIXED_01",
                    "fixed_asset_path": str(ROOT / "assets" / "ai_background_templates_dynamic" / "BG_DYNAMIC_01_钛金神经中枢_16x9.mp4"),
                    "fixed_asset_exists": True,
                    "dynamic_asset_id": "BG_DYNAMIC_01",
                    "dynamic_asset_path": str(ROOT / "assets" / "ai_background_templates_dynamic" / "BG_DYNAMIC_01_钛金神经中枢_16x9.mp4"),
                    "dynamic_poster_path": str(ROOT / "assets" / "ai_background_templates_dynamic" / "BG_DYNAMIC_01_钛金神经中枢_16x9.poster.png"),
                    "dynamic_asset_exists": True,
                    "render_asset_path": str(ROOT / "assets" / "ai_background_templates_dynamic" / "BG_DYNAMIC_01_钛金神经中枢_16x9.mp4"),
                    "render_asset_type": "fixed_dynamic_background_video_asset",
