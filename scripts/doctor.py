...
REQUIRED_PATHS = [
    ...
    "references/premium_motion_layout_contract.md",
    ...
    "references/hook_pattern_bank.md",
    "references/copy_hook_scoring_rules.md",
    "references/beginner_copywriting_rules.md",
    ...
    "references/ai_video_scheme_library.md",
    "references/ai_video_scheme_1_skill_recommendation_no_voice.md",
    "references/ai_reference_video_outcome_registry.md",
    ...
    "references/global_douyin_text_compliance_rule.md",
    "references/forbidden_terms_learning_bank.md",
    ...
    "schemas/beginner_value_review.schema.json",
    "schemas/semantic_review.schema.json",
    "schemas/content_alignment_report.schema.json",
    ...
    "schemas/source_research.schema.json",
    ...
    "templates/publish_copy.template.md",
    ...
    "tests/test_content_alignment.py",
    "tests/test_qa_gate.py",
    "tests/test_v3_gates.py",
    "tests/test_beginner_copy.py",
    "tests/test_visual_tone.py",
    "tests/test_fixed_ai_background_assets.py",
    ...
    "scripts/seed_topic_candidates.py",
    "scripts/validate_source_research.py",
    "scripts/generate_copy_candidates.py",
    "scripts/score_script.py",
    "scripts/validate_beginner_copy.py",
    "scripts/train_beginner_copy.py",
    "scripts/check_public_copy.py",
    "scripts/check_content_alignment.py",
    "scripts/voice_quality.py",
    ...
    "scripts/score_hook_variants.py",
    "scripts/audit_reference_overfit.py",
    "scripts/select_fixed_ai_templates.py",
    "scripts/generate_fixed_ai_background_assets.py",
    "scripts/generate_dynamic_ai_background_assets.py",
    "scripts/asset_prompt_contract.py",
    "scripts/validate_asset_prompts.py",
    "scripts/validate_visual_tone.py",
    ...
    "scripts/adapt_douyin_vertical.py",
    ...
    "references/fixed_ai_production_templates.md",
    "references/video_style_profiles.md",
    ...
    "assets/ai_background_templates_fixed_archive/README.md",
    "assets/ai_background_templates_fixed_archive/asset_manifest.json",
    "assets/ai_background_templates_dynamic/README.md",
    "assets/ai_background_templates_dynamic/dynamic_asset_manifest.json",
